...
// https://www.elastic.co/guide/en/elasticsearch/reference/6.7/allocation-filtering.html
...
func (c *Client) ListNodes() ([]string, error) {
	nodesInfo, err := c.client.NodesInfo().Do(c.ctx)
	if err != nil {
...
// Shutdown does nothing, because Elasticsearch 6.x does not have shutdown API
